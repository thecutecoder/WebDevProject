                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
															<img src="{{asset('image/'.$student->student_image)}}" width="100px" height="100px"/>
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                        <div class="product-payment-inner-st res-mg-t-30 analysis-progrebar-ctn">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Profile Page</a></li>
                            </ul>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <h2>Personal Details</h2>
                                                        ...
                                                        <div class="address-hr biography">
                                                            ...
                                                            <p><input type="text" class="form-control" name="last_name" value="{{ $student->id }}" readonly></p>
                                                        </div>
                                                        <div class="address-hr biography">
                                                            <p><b>Password</b><br/></p>
                                                            <p><input type="text" class="form-control" name="last_name" value="{{ $student->password }}" readonly></p>
                                                        </div>
                                                        <div class="content-profile">
                                                            <p><b>Full Name</b><br/></p>
                                                            <p><input type="text" class="form-control" name="last_name" value="{{ $student->full_name }}" readonly></p>
                                                        </div>
                                                        <div class="address-hr biography">
                                                            <p><b>Year</b><br/></p>
                                                            <p><input type="text" class="form-control" name="last_name" value="{{ $student->years }}" readonly></p>
                                                        </div>
                                                        <div class="address-hr biography">
                                                            <p><b>Email</b><br/></p>
                                                            <p><input type="text" class="form-control" name="last_name" value="{{ $student->email }}" readonly></p>
                                                        </div>
                                                        <div class="address-hr biography">
                                                            <p><b>Home Address</b><br/></p>
                                                            <p><input type="text" class="form-control" name="last_name" value="{{ $student->home_address }}" readonly></p>
                                                        </div>
                                                        <div class="address-hr biography">
                                                            <a href="{{ url('/student/update', $student->id)}}"  class="link-update">Update</a>
                                                        </div>
                                                    </div>
                                            </div>
                                        </div>
