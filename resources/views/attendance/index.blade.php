            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a title="Landing Page" href="/attendance/indexs" ><img class="main-logo" src="{{asset('assets/img/icons/clipboard.png')}}" width="20px" height="20px" /> Attendance</span></a>
                        </li>
                        <li>
