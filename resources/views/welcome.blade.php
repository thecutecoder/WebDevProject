...
<body>
    ...
    <div class="all-content-wrapper">
       ...
       <div class = "dateandtime">
        <p>Today Date and Time is <span id='date-time'></span>.</p>
        <script>
            var dt = new Date();
        ...
        <!-- Start Announcement -->
            ...
            <div class = "annoucement">
              <marquee width="70%" direction="up" height="100%">
                <header>
                      <h1>ANNOUCEMENT FOR STUDENTS UNDERGRADUATE AND POSTGRADUATE!</h1>
                      <li>Since Tomorrow (29 April 2021) is Nuzul Quran Day,
                          Thus, there are no class for tomorrow</li><br>
                        <li>Please remember to update your attandance</li><br>
                        <li>Please take note your assignment due date</li><br>
                    </header>
              </marquee>
            </div>
